# MQTT_Application
Demonstrate a MQTT server and connection setting, sending message from publisher and receive from subcriber.<br>
Folder "Websocket" suitable for testing/ initall connection or for debug.<br>
